...
namespace Pulumi.infoblox
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.infoblox.version.txt");
    ...
    internal sealed class infobloxResourceTypeAttribute : Pulumi.ResourceTypeAttribute
    {
        public infobloxResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}

PROJECT_NAME := Pulumi infoblox Resource Provider

PACK             := infoblox
PACKDIR          := sdk
PROJECT          := github.com/gpduck/pulumi-infoblox
NODE_MODULE_NAME := @pulumi/infoblox
NUGET_PKG_NAME   := Pulumi.infoblox
...
SCHEMA_FILE     := provider/cmd/pulumi-resource-infoblox/schema.json

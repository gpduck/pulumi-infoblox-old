...
import (
	...
	providerVersion "github.com/gpduck/pulumi-infoblox/provider/pkg/version"
...
// BaseDir is the path to the base pulumi-infoblox directory.
var BaseDir string
...
func main() {
	flag.Usage = func() {
		const usageFormat = "Usage: %s <language> <swagger-or-schema-file> <root-pulumi-infoblox-dir>"
